 ...
 */
public class ObjectCell extends TreeCell<TreeObject> {
...
//        super.startEdit();//made some problems with tree.setEdibale(false)
    ...
    @Override
    public void commitEdit(TreeObject t) {
        super.commitEdit(t);
        updateItem(t, false);
    ...
    @Override
    public void updateItem(TreeObject item, boolean emty) {
    ...
    private void addContexMenu(TreeItem<TreeObject> objectItem) {
        try {
